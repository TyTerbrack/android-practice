...
public class EditorActivity extends AppCompatActivity implements LoaderManager
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Examine intent to determine editor mode
        Intent intent = getIntent();
        mCurrentPetUri = intent.getData();

        // Change title to correspond with editor mode
    ...
    private void showUnsavedChangesDialog(DialogInterface.OnClickListener
        ...
        // Create AlertDialog.Builder and set message and click listeners
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                // Dismiss dialog and continue editing pet
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    private void savePet() {
        ...
        // Do not save if the user did not edit any fields
        if (mCurrentPetUri == null && TextUtils.isEmpty(nameString) && TextUtils.isEmpty
                (breedString) && TextUtils.isEmpty(weightString) && mGender == PetEntry
                .GENDER_UNKNOWN) {
            return;
        }

        // Create and fill ContentValues object
        ...
        if (mCurrentPetUri == null) {
            // Insert a new row for the pet in the database, returning the content uri
            ...
            if (rowsAffected == 0) {
                // Error updating pet
                Toast.makeText(this, R.string.update_unsuccessful, Toast.LENGTH_SHORT).show();
            } else {
                // Successful update
    ...
    private void deletePet() {
        // Only delete if there is an existing pet
        if (mCurrentPetUri != null) {
    ...
    public void onBackPressed() {
        // If pet hasn't changed, continue handling back button press
        if(!mPetHasChanged) {
            super.onBackPressed();
            return;
        }

        // Create click listener to discard changes
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                // If pet hasn't changed, continue handling up button press
                if (!mPetHasChanged) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Hide "Delete" if this is a new pet
        if (mCurrentPetUri == null) {
